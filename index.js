...
function reveal() {
  ...
  ifrm.setAttribute("src", "https://www.youtube.com/embed/_eyFvp9R_j4?controls=0&loop=1&autoplay=1");
...
var countDownDate = new Date("May 2, 2021 00:00:00").getTime();
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "MANY MORE HAPPY RETURNS OF THE DAY";
    document.getElementById("k").innerHTML = "gurjjjjiiiiiii"
  ...
  {
  var now = new Date().getTime();
  var distances=now-countDownDates;
  ...
  document.getElementById("demo1").innerHTML = dayss + "d " + hourss + "h "
